...
def generate_for_manifest(
    ...
    *,
    ...
    if prompt_manifest_path is not None:
        prompt_samples = read_manifest(prompt_manifest_path)
        prompt_grouped = group_by_speaker(prompt_samples)
    pairs = build_pairs(
        grouped,
...
def main() -> None:
    ...
    for dataset in args.datasets:
        ...
        val_count = generate_for_manifest(
            ...
            min_code_len=args.min_code_len,
            max_pairs=max_pairs,
            prompt_manifest_path=train_manifest,
        )
